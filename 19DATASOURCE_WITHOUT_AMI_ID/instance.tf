...
data "aws_ami" "ubuntu" {
  most_recent = true
  owners      = ["099720109477"] #owner name should be copyied by ami in image(by searching image id it show by officialy ammazon ) do not copy from self made instance 
